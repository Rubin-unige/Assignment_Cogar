// Generated by gencpp from file assignment_cogar/RobotStatus.msg
// DO NOT EDIT!


#ifndef ASSIGNMENT_COGAR_MESSAGE_ROBOTSTATUS_H
#define ASSIGNMENT_COGAR_MESSAGE_ROBOTSTATUS_H
...
struct RobotStatus_
{
  ...
  typedef boost::shared_ptr< ::assignment_cogar::RobotStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::assignment_cogar::RobotStatus_<ContainerAllocator> const> ConstPtr;

}; // struct RobotStatus_

typedef ::assignment_cogar::RobotStatus_<std::allocator<void> > RobotStatus;

typedef boost::shared_ptr< ::assignment_cogar::RobotStatus > RobotStatusPtr;
typedef boost::shared_ptr< ::assignment_cogar::RobotStatus const> RobotStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::assignment_cogar::RobotStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::assignment_cogar::RobotStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::assignment_cogar::RobotStatus_<ContainerAllocator1> & lhs, const ::assignment_cogar::RobotStatus_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::assignment_cogar::RobotStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::assignment_cogar::RobotStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::assignment_cogar::RobotStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::assignment_cogar::RobotStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe29185a01811c1afULL;
  static const uint64_t static_value2 = 0xe86cbc3bbc80a5fdULL;
};

template<class ContainerAllocator>
struct DataType< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::assignment_cogar::RobotStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::assignment_cogar::RobotStatus_<ContainerAllocator>& v)
  {
    s << indent << "robot_id: ";
...
#endif // ASSIGNMENT_COGAR_MESSAGE_ROBOTSTATUS_H
