...
(cl:defmethod cl:initialize-instance :after ((m <OrderStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrderStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-msg:<OrderStatus> is deprecated: use sushi_bot-msg:OrderStatus instead.")))
...
(cl:defmethod dish_name-val ((m <OrderStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sushi_bot-msg:dish_name-val is deprecated.  Use sushi_bot-msg:dish_name instead.")
  (dish_name m))
...
(cl:defmethod requires_staff_attention-val ((m <OrderStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sushi_bot-msg:requires_staff_attention-val is deprecated.  Use sushi_bot-msg:requires_staff_attention instead.")
