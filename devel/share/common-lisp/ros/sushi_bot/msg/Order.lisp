...
(cl:defmethod cl:initialize-instance :after ((m <Order>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Order)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-msg:<Order> is deprecated: use sushi_bot-msg:Order instead.")))
...
(cl:defmethod table_id-val ((m <Order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sushi_bot-msg:table_id-val is deprecated.  Use sushi_bot-msg:table_id instead.")
  (table_id m))
