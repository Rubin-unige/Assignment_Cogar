...
(cl:defmethod cl:initialize-instance :after ((m <VerifyOrder-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VerifyOrder-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-srv:<VerifyOrder-request> is deprecated: use sushi_bot-srv:VerifyOrder-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <VerifyOrder-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VerifyOrder-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-srv:<VerifyOrder-response> is deprecated: use sushi_bot-srv:VerifyOrder-response instead.")))
