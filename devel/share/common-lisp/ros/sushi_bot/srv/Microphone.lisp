...
(cl:defmethod cl:initialize-instance :after ((m <Microphone-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Microphone-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-srv:<Microphone-request> is deprecated: use sushi_bot-srv:Microphone-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Microphone-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Microphone-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sushi_bot-srv:<Microphone-response> is deprecated: use sushi_bot-srv:Microphone-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <Microphone-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sushi_bot-srv:response-val is deprecated.  Use sushi_bot-srv:response instead.")
  (response m))
