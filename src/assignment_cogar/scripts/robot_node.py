...
from strategies.safe_path import SafePathStrategy
...
def handle_task(msg):
    ...
    # For example, you could switch dynamically like:
    # strategy = SafePathStrategy() if table == "Table 3" else FastestPathStrategy()

    # Set up and execute commands using the Command + Strategy pattern
